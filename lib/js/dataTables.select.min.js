...
!(function(a) {
  ...
  function e(a, b, c) {
    ...
    a.cells({ selected: !0 }).any() || c
      ? ((e = g(c.column, b.column)), (f = h(c.row, b.row)))
      : ((e = g(0, b.column)), (f = h(0, b.row))),
  ...
  function f(b) {
    ...
    a(b.table().body())
      .off("mousedown.dtSelect", d)
      .off("mouseup.dtSelect", d)
      .off("click.dtSelect", d),
      a("body").off("click.dtSelect");
  }
  function g(c) {
    ...
    d
      .on("mousedown.dtSelect", f, function(a) {
        a.shiftKey &&
          d
            ...
            .one("selectstart.dtSelect", f, function() {
              return !1;
            });
      })
      ...
      .on("click.dtSelect", f, function(d) {
        ...
        if (!b.getSelection || !b.getSelection().toString()) {
          var g = c.settings()[0];
          if (
            a(d.target).closest("div.dataTables_wrapper")[0] ==
            c.table().container()
          ) {
            ...
            c.cell(h).any() &&
              ("row" === f
                ? ((e = i.row), m(d, c, g, "row", e))
                : "column" === f
                ? ((e = c.cell(h).index().column), m(d, c, g, "column", e))
                : "cell" === f &&
                  ((e = c.cell(h).index()), m(d, c, g, "cell", e)),
      ...
      a("body").on("click.dtSelect", function(b) {
        if (e._select.blurable) {
          if (
            a(b.target)
              .parents()
              .filter(c.table().container()).length
          )
            return;
  ...
  function h(b, c, d, e) {
    (e && !b.flatten().length) ||
      (d.unshift(b), a(b.table().node()).triggerHandler(c + ".dt", d));
  }
  function i(b) {
    var c = b.settings()[0];
    if (c._select.info && c.aanFeatures.i) {
      var d = a('<span class="select-info"/>'),
        e = function(c, e) {
          d.append(
            a('<span class="select-item"/>').append(
              b.i18n(
                "select." + c + "s",
                {
                  _: "%d " + c + "s selected",
    ...
    b.aoRowCreatedCallback.push({
      fn: function(c, d, e) {
        var f,
          ...
          h = b.aoData[e];
        for (
          h._select_selected && a(c).addClass(b._select.className),
            f = 0,
            g = b.aoColumns.length;
          g > f;
          f++
        )
          (b.aoColumns[f]._select_selected ||
            (h._selected_cells && h._selected_cells[f])) &&
            a(h.anCells[f]).addClass(b._select.className);
      },
  ...
  function k(b, c, d, e) {
    ...
    b[c](d, { selected: !0 }).any()
      ? (f.splice(a.inArray(d, f), 1), b[c + "s"](f).deselect())
      : b[c + "s"](f).select();
  }
  function l(a, b) {
  ...
  function m(a, b, c, d, f) {
    ...
    if ("os" === g)
      if (a.ctrlKey || a.metaKey) b[d](f).select(!h);
        ...
        "cell" === d
          ? e(b, f, c._select_lastCell || null)
          : k(b, d, f, c._select_lastCell ? c._select_lastCell[d] : null);
      else {
        var i = b[d + "s"]({ selected: !0 });
        h && 1 === i.flatten().length
          ? b[d](f).deselect()
          : (i.deselect(), b[d](f).select());
      }
    else b[d](f).select(!h);
  }
  function n(a, b) {
    ...
    (o.select.init = function(b) {
      ...
      (c._select = {}),
        g === !0
          ...
          ? (i = g)
          : a.isPlainObject(g) &&
            (g.blurable !== d && (j = g.blurable),
            g.info !== d && (k = g.info),
            g.items !== d && (h = g.items),
            g.style !== d && (i = g.style),
            g.selector !== d && (l = g.selector),
            g.className !== d && (m = g.className)),
        b.select.selector(l),
        b.select.items(h),
        b.select.style(i),
        b.select.blurable(j),
          ...
          return this.api()
            ...
            .map(function(c) {
              return "row" === b._select.items
                ...
                ? a(c).hasClass(b._select.className)
                : !1;
            });
        }),
      ...
      function(a, b) {
        o.ext.selector[b.type].push(function(a, c, e) {
          ...
          for (var i = 0, j = e.length; j > i; i++)
            (f = a[b.prop][e[i]]),
              ((g === !0 && f._select_selected === !0) ||
                (g === !1 && !f._select_selected)) &&
                h.push(e[i]);
          return h;
        });
      }
    ...
    o.ext.selector.cell.push(function(a, b, c) {
      ...
      for (var h = 0, i = c.length; i > h; h++)
        (e = a.aoData[c[h].row]),
          ((f === !0 &&
            e._selected_cells &&
            e._selected_cells[c[h].column] === !0) ||
            (f === !1 &&
              (!e._selected_cells || !e._selected_cells[c[h].column]))) &&
            g.push(c[h]);
      return g;
    });
      ...
      return a === d
        ...
        : this.iterator("table", function(b) {
            f(new o.Api(b)),
              ...
              "api" !== b._select.style && g(new o.Api(b));
          });
    }),
      ...
      return b === !1
        ...
        : (this.iterator("row", function(b, c) {
            l(b),
              ...
              a(b.aoData[c].nTr).addClass(b._select.className);
          }),
    ...
    q("columns().select()", "column().select()", function(b) {
      ...
      return b === !1
        ...
        : (this.iterator("column", function(b, c) {
            ...
            a(d.header()).addClass(b._select.className),
              a(d.footer()).addClass(b._select.className),
              d
                .nodes()
                .to$()
    ...
    q("cells().select()", "cell().select()", function(b) {
      ...
      return b === !1
        ...
        : (this.iterator("cell", function(b, c, e) {
            l(b);
            var f = b.aoData[c];
            f._selected_cells === d && (f._selected_cells = []),
              (f._selected_cells[e] = !0),
              f.anCells && a(f.anCells[e]).addClass(b._select.className);
          }),
          this.iterator("table", function(a, b) {
      ...
      return (
        this.iterator("row", function(b, c) {
          (b.aoData[c]._select_selected = !1),
            a(b.aoData[c].nTr).removeClass(b._select.className);
        }),
          ...
          a(e.header()).removeClass(b._select.className),
            ...
            d
              ...
              .each(function(c) {
                ...
                !d.anCells ||
                  (e && e[c.column]) ||
                  a(d.anCells[c.column]).removeClass(b._select.className);
              });
        }),
        this.iterator("table", function(a, c) {
    ...
    q("cells().deselect()", "cell().deselect()", function() {
      ...
      return (
        this.iterator("cell", function(b, c, d) {
          var e = b.aoData[c];
          (e._selected_cells[d] = !1),
            e.anCells &&
              !b.aoColumns[d]._select_selected &&
              a(e.anCells[d]).removeClass(b._select.className);
        }),
        this.iterator("table", function(a, c) {

...
!(function(a) {
  ...
  var e = a.fn.dataTable,
    ...
    i = function(b, c) {
      c === !0 && (c = {}),
        ...
        (this.dom = {
          container: a("<" + this.c.dom.container.tag + "/>").addClass(
  ...
  a.extend(i.prototype, {
    ...
    active: function(a, b) {
      ...
      return b === d
        ? c.node.hasClass(e)
        : (c.node.toggleClass(e, b === d ? !0 : b), this);
    },
    add: function(a, b) {
      ...
      return (
        this.dom.container.empty(), this._buildButtons(this.c.buttons), this
      );
    },
    container: function() {
    ...
    destroy: function() {
      ...
      for (b = 0, c = f.length; c > b; b++)
        for (this.removePrep(b), d = 0, e = g[b].length; e > d; d++)
          this.removePrep(b + "-" + d);
    ...
    removeCommit: function() {
      ...
      for (a = d.length - 1; a >= 0; a--)
        null === d[a] &&
          (d.splice(a, 1), e.splice(a, 1), this.c.buttons.splice(a, 1));
      for (a = 0, b = e.length; b > a; a++)
        for (c = e[a].length - 1; c >= 0; c--)
          null === e[a][c] &&
            (e[a].splice(c, 1), this.c.buttons[a].buttons.splice(c, 1));
      return this;
    },
    ...
    text: function(a, b) {
      var c = this._indexToButton(a),
        ...
        f =
          "string" == typeof a && -1 !== a.indexOf("-") && e && e.tag
            ? e.tag
      ...
      return b === d
        ? h(c.conf.text)
        : ((c.conf.text = b),
          f ? c.node.children(f).html(h(b)) : c.node.html(h(b)),
          this);
    },
    toIndex: function(a) {
      var b,
    ...
    _addKey: function(b) {
      b.key &&
        (this.s.listenKeys += a.isPlainObject(b.key) ? b.key.key : b.key);
    },
          ...
          if (a.isArray(j)) this._buildButtons(j, c, e);
            ...
            if (k) {
              ...
              if (
                ...
                (j._collection = a("<" + m.tag + "/>").addClass(m.className)),
                  this._buildButtons(j.buttons, j._collection, g);
              }
    ...
    _buildButton: function(b, c) {
      ...
      if (
        (c && f.button && (d = f.button),
        c && f.buttonLiner && (e = f.buttonLiner),
        b.available && !b.available(h, b))
      )
        return !1;
      var j = function(b, c, d, e) {
          e.action.call(c.button(d), b, c, d, e),
            a(c.table().node()).triggerHandler("buttons-action.dt", [
              c.button(d),
              c,
              d,
              e
        ...
        k = a("<" + d.tag + "/>")
          ...
          .on("click.dtb", function(a) {
            a.preventDefault(),
              !k.hasClass(d.disabled) && b.action && j(a, h, k, b),
              k.blur();
          })
          .on("keyup.dtb", function(a) {
            13 === a.keyCode &&
              !k.hasClass(d.disabled) &&
              b.action &&
              j(a, h, k, b);
          });
      e.tag
    ...
    _resolveExtends: function(b) {
      ...
      for (b = g(b); b && b.extend; ) {
        if (!h[b.extend])
          throw "Cannot extend unknown button type: " + b.extend;
        var i = g(h[b.extend]);
        if (a.isArray(i)) return i;
        if (!i) return !1;
        var j = i.className;
        (b = a.extend({}, i, b)),
          j && b.className !== j && (b.className = j + " " + b.className);
        var k = b.postfixButtons;
        if (k) {
          for (b.buttons || (b.buttons = []), c = 0, e = k.length; e > c; c++)
            b.buttons.push(k[c]);
          b.postfixButtons = null;
        }
        var l = b.prefixButtons;
        if (l) {
          for (b.buttons || (b.buttons = []), c = 0, e = l.length; e > c; c++)
            b.buttons.splice(c, 0, l[c]);
          ...
          f = function(b, c) {
            ...
            if (a.isArray(b) || b instanceof a)
              ...
              for (g = 0, h = i.length; h > g; g++)
                e.push({ inst: c, idx: c.toIndex(i[g].node) });
    ...
    a.extend(h, {
      collection: {
        ...
        action: function(d, e, f, g) {
          var h = f,
            ...
            l = !1;
          a("div.dt-button-background").length &&
            ((l = a("div.dt-button-collection").offset()),
            a(c).trigger("click.dtb-collection")),
            g._collection
          ...
          if (l && "absolute" === m)
            g._collection.css({ top: l.top + 5, left: l.left + 5 });
          else if ("absolute" === m) {
            ...
            p > a(b).height() / 2 && (p = a(b).height() / 2),
              g._collection.css("marginTop", -1 * p);
          }
      ...
      copy: function(a, b) {
        return h.copyHtml5
          ? "copyHtml5"
          : h.copyFlash && h.copyFlash.available(a, b)
          ? "copyFlash"
          : void 0;
      },
      csv: function(a, b) {
        return h.csvHtml5 && h.csvHtml5.available(a, b)
          ? "csvHtml5"
          : h.csvFlash && h.csvFlash.available(a, b)
          ? "csvFlash"
          : void 0;
      },
      excel: function(a, b) {
        return h.excelHtml5 && h.excelHtml5.available(a, b)
          ? "excelHtml5"
          : h.excelFlash && h.excelFlash.available(a, b)
          ? "excelFlash"
          : void 0;
      },
      pdf: function(a, b) {
        return h.pdfHtml5 && h.pdfHtml5.available(a, b)
          ? "pdfHtml5"
          : h.pdfFlash && h.pdfFlash.available(a, b)
          ? "pdfFlash"
          : void 0;
      },
    ...
    e.Api.register("buttons()", function(a, b) {
      return (
        ...
        this.iterator(
          ...
          function(c) {
            return c._buttons
              ? i.buttonSelector(i.instanceSelector(a, c._buttons), b)
              : void 0;
          },
          !0
        )
    ...
    e.Api.registerPlural("buttons().active()", "button().active()", function(
      a
    ) {
      return a === d
        ? this.map(function(a) {
    ...
    e.Api.registerPlural("buttons().action()", "button().action()", function(
      a
    ) {
      return a === d
        ? this.map(function(a) {
  ...
  var k = a("<textarea/>")[0],
    l = function(b, c) {
      for (
        var d = a.extend(
          ...
          e = function(a) {
            return "string" != typeof a
              ? a
              : (d.stripHtml && (a = a.replace(/<.*?>/g, "")),
                d.trim && (a = a.replace(/^\s+|\s+$/g, "")),
                d.stripNewlines && (a = a.replace(/\n/g, " ")),
                d.decodeEntities && ((k.innerHTML = a), (a = k.value)),
                a);
          },
          f = b
            .columns(d.columns)
        ...
        for (var q = new Array(j), r = 0; j > r; r++)
          (q[r] = d.format.body(i[n], r, o)), n++;
        m[o] = q;
      }
